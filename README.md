# Keycloak Docker setup with NGINX Proxy, Letsencrypt, hosted on AWS EC2 with managed Postgres DB on AWS RDS, and SSL cert config for federation with windows active directory
